...
public class Board
{
  ...
  public Board(boolean aIsValid, GameState aStateForMatch, boolean aIsNewForMatch, int aIdForMatch, int aTimeLimitForMatch, Quoridor aQuoridorForMatch)
  {
    isValid = aIsValid;
    tiles = new ArrayList<Tile>();
    match = new Match(aStateForMatch, aIsNewForMatch, aIdForMatch, aTimeLimitForMatch, this, aQuoridorForMatch);
  }

...
public class Quoridor
{
  ...
  /* Code from template association_AddManyToOne */
  public Match addMatche(Match.GameState aState, boolean aIsNew, int aId, int aTimeLimit, Board aBoard)
  {
    return new Match(aState, aIsNew, aId, aTimeLimit, aBoard, this);
  }

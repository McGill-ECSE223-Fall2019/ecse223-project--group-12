...
public class RotateWallStepDefinitions {
	...
	public void the_wall_shall_be_rotated_over_the_board_to(String string) {
		...
		PlayerPosition playerPosition = TestUtil
				.getPlayerPositionByColor(game.getCurrentPosition().getPlayerToMove().getUser().getName());
		Player player = TestUtil.getPlayerByColor(game.getCurrentPosition().getPlayerToMove().getUser().getName());
